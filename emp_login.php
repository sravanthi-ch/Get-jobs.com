<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT * FROM employer WHERE username = '$myusername' and password = '$mypassword'";
                        ...
                        <div class="panel" id="contact">
                            ...
                            <div class="col_380 float_l">
                                <div id="contact_form">
									...
									click here to <a href="register_emp.php">register</a> newly
                                </div>
                            </div>
