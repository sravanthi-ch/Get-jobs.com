 ...
 <!-- end of home -->
                        ...
                        <div class="panel" id="contact">
                            ...
                            <div class="col_380 float_l">
								 ...
								 <h2>Messages</h2>
								 <h4>name &nbsp&nbsp email &nbsp&nbsp message</h4>
								 <?php
								    while($row=mysqli_fetch_row($result))
									{
										echo $row[1] ; echo "&nbsp &nbsp &nbsp";
										echo $row[2]; echo "&nbsp &nbsp &nbsp";
										echo $row[3]; echo nl2br("\r\n");
										
									}
								 ?>
								<br>
                                	<a href="total_cand.php"><button>Registered Candidates</button></a><br><br>
									<a href="total_emp.php"><button>Registered Employers</button></a><br><br>
									<a href="services.html"><button>Logout</button></a>
                            </div>
